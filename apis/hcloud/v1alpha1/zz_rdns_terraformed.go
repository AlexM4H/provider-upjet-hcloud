...
func (tr *Rdns) GetObservation() (map[string]interface{}, error) {
...
func (tr *Rdns) SetObservation(obs map[string]interface{}) error {
...
func (tr *Rdns) GetParameters() (map[string]interface{}, error) {
...
func (tr *Rdns) SetParameters(params map[string]interface{}) error {

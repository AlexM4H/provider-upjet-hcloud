...
func (tr *BalancerService) GetObservation() (map[string]interface{}, error) {
...
func (tr *BalancerService) SetObservation(obs map[string]interface{}) error {
...
func (tr *BalancerService) GetParameters() (map[string]interface{}, error) {
...
func (tr *BalancerService) SetParameters(params map[string]interface{}) error {

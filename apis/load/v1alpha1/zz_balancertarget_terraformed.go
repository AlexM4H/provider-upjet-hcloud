...
func (tr *BalancerTarget) GetObservation() (map[string]interface{}, error) {
...
func (tr *BalancerTarget) SetObservation(obs map[string]interface{}) error {
...
func (tr *BalancerTarget) GetParameters() (map[string]interface{}, error) {
...
func (tr *BalancerTarget) SetParameters(params map[string]interface{}) error {
